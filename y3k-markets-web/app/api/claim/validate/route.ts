...
export async function POST(request: Request) {
  const VALID_TOKENS: Record<string, any> = {
    ...
    // ============================================
    // NAMED NAMESPACE: brad.x - Bradley (DISABLED FOR VIP PROTOCOL)
    // ============================================
    // 'brad': {
    //   namespace: 'brad.x',
    //   displayName: 'Genesis Founder',
    //   realName: 'Bradley',
    //   description: "Your personal sovereign namespace - brad.x. Clean, professional, and unmistakably yours. Perfect for building your Web3 brand and decentralized identity.",
    //   whatYouOwn: [
    //     'Primary namespace: brad.x — Your digital identity',
    //     'Authentication: brad.auth.x — Secure login across Web3',
    //     'Finance: brad.finance.x — DeFi treasury & payments',
    //     'Communications: brad.tel.x — Encrypted messaging',
    //     'Storage: brad.vault.x — Secure file storage',
    //     'Registry: brad.registry.x — Subdomain management'
    //   ],
    //   certificates: ['brad.x', 'brad.auth.x', 'brad.finance.x', 'brad.tel.x', 'brad.vault.x', 'brad.registry.x'],
    ...
    'brad-2026-01-17-br4d89a7b6c5d4e3f2g1h0br4d89': {
      ...
      displayName: 'Genesis Founder',
      realName: 'Bradley',
      description: "Your personal sovereign namespace - brad.x.",
      certificates: ['brad.x', 'brad.auth.x', 'brad.finance.x', 'brad.tel.x', 'brad.vault.x', 'brad.registry.x'],
      valid: true
    },
